function [ fs, dout ] = normMatFiles( fs, d )
%NORMMATFILES Normalize a set of PIV mat files.
...
Xo		= -111.746;			% Trailing edge X coordinate [mm]
Yo		= 35.611;			% Trailing edge Y coordinate [mm]
